...
export const LLM_DOCS_SHAPES: Record<WireDocsTopic, WireDocsShape> = {
  ...
  cloud: {
    id: "wire.cloud",
    kind: "contract",
    summary: "Wire Cloud persistence, API key, and share URL contract.",
    useWhen: [
    ...
    contracts: ["wire-cloud-api-key", "wire-cloud-share-urls", "wire-cloud-sync"],
    preferredPath: [
    ...
    avoid: [
      ...
      "Do not store the generated API key in docs, screenshots, or committed files."
    ],
    routes: [
...
export const LLM_DOCS_RECIPES = {
  ...
  "connect-local-mcp": {
    ...
    claudeCodeCommand: "claude mcp add wire --env WIRE_CLOUD_URL='https://reefagent-mcp-wire.vercel.app' --env WIRE_CLOUD_API_KEY='PASTE_GENERATED_KEY' -- npx -y @aigentive/wire-mcp@latest",
    mcpJson: {
      mcpServers: {
        wire: {
          command: "npx",
    ...
    smokeTest: "curl -sS 'https://reefagent-mcp-wire.vercel.app/api/cloud/me' -H 'Authorization: Bearer PASTE_GENERATED_KEY'"
  },
  "repair-invalid-diagram": {
...
const TASK_HINTS: Record<WireDocsTopic, string[]> = {
  ...
  cloud: ["cloud", "api key", "auth", "google", "share", "preview", "sync", "vercel"],
