  ...
  return (
    <div
      className={[
        ...
        "[&_h2]:m-0 [&_h2]:mt-6 [&_h2]:scroll-mt-24 [&_h2]:text-[22px] [&_h2]:font-bold [&_h2]:tracking-tight [&_h2]:text-wire-primary",
        "[&_h3]:m-0 [&_h3]:mt-4 [&_h3]:scroll-mt-24 [&_h3]:text-[16px] [&_h3]:font-bold [&_h3]:tracking-tight [&_h3]:text-wire-primary",
        ...
        "[&_a]:text-wire-link [&_a]:underline [&_a]:underline-offset-2",
...
export function InlineCode({ children }: { children: ReactNode }) {
  return (
    <code className="rounded-sm bg-wire-sunken px-[5px] py-[1px] font-mono text-[12.5px] text-wire-primary">
      {children}
    </code>
  );
}
